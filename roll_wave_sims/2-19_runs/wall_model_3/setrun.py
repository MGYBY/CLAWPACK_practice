...
x_cell = 2100
y_cell = int(x_cell/(domain_x/domain_y))
...
#-------------------
    ...
    geo_data.manning_coefficient = cf
    geo_data.friction_depth = 10.0
    geo_data.friction_type = int(2.0)

    # Refinement data
    refinement_data = rundata.refinement_data
    refinement_data.wave_tolerance = 1.e2
    refinement_data.deep_depth = 1e2
    refinement_data.max_level_deep = 3
    # refinement_data.speed_tolerance = [un*1.20, un*1.40, un*1.60] # AMR for roll waves
    ...
    topo_data.topofiles.append([2, 1, 10, 0., 1.e10, 'channel.topotype2'])
