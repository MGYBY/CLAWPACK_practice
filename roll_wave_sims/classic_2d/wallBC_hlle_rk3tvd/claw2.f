...
c     ==============================================================
c     modified version of the classic2 standard library
c     added feature: RK3TVD time integration
c
c
c
...
c
c           # RK3TVD time integration
c           # implemented in dimsp
            call dimsp2(maxm,meqn,mwaves,maux,mbc,mx,my,
     &                  work(i0qwrk1),qmed1,aux,
