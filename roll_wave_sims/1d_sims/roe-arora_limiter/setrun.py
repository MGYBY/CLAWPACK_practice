...
#------------------------------
    ...
    from clawpack.riemann.shallow_roe_with_efix_1D_constants import depth, momentum, num_eqn, num_waves
    ...
    #   4 or 'mc'       ==> MC limiter
    # use roe-arora limiter
    clawdata.limiter = [6, 6]
